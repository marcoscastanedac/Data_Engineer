...
with DAG(
    dag_id='dag_ingest_transform_anac', # Nombre del DAG
	...
	ingest_task = BashOperator(
        	...
        	task_id = 'ingest_data',
        	#Ruta del script
        	bash_command = '/usr/bin/sh /home/hadoop/scripts/ingest_to_hdfs_anac.sh ',
	)
	...
	transform_task = BashOperator(
        	...
        	#Ruta del script
        	bash_command = 'ssh hadoop@172.17.0.2 /home/hadoop/spark/bin/spark-submit --files /home/hadoop/hive/conf/hive-site.xml /home/hadoop/scripts/transform_spark_sql_anac.py ',
	)
