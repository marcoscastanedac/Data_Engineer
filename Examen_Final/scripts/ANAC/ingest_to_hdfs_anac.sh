...
FILE_URL_1="https://dataengineerpublic.blob.core.windows.net/data-engineer/2021-informe-ministerio.csv"
FILE_URL_2="https://dataengineerpublic.blob.core.windows.net/data-engineer/202206-informe-ministerio.csv"
FILE_URL_3="https://dataengineerpublic.blob.core.windows.net/data-engineer/aeropuertos_detalle.csv"
FILE_NAME_1="2021-informe-ministerio.csv"
FILE_NAME_2="202206-informe-ministerio.csv"
FILE_NAME_3="aeropuertos_detalle.csv"
...
wget -O $FILE_NAME_3 $FILE_URL_3

# Verificar si la descarga fue exitosa
for FILE_NAME in "$FILE_NAME_1" "$FILE_NAME_2" "$FILE_NAME_3"; do
